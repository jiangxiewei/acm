...
|    11    |        盛最多水的容器        |    中等     |                                           需要灵机一现的双指针                                            |                                       [leetCode.repository.No11盛最多水的容器](src/leetCode/repository/No11盛最多水的容器.java)                                       |
|    12    |        整数转罗马数字        |  中等(简单)   |                                              除+取余                                               |                                       [leetCode.repository.No12整数转罗马数字](src/leetCode/repository/No12整数转罗马数字.java)                                       |
|    13    |        罗马数字转整数        |    简单     |                                              简单的规则                                              |                                       [leetCode.repository.No13罗马数字转整数](src/leetCode/repository/No13罗马数字转整数.java)                                       |
|    15    |         三数之和          |    中等     |                                          两数之和进阶版(本质一样)                                          |                                      [leetCode.repository.No15_3sum.java](src/leetCode/repository/No15_3sum.java)                                       |
|    16    |       最接近的三数之和        |    中等     |                                          夹逼，思路和No.11类似                                          |                                   [leetCode.repository.No16最接近的三数之和.java](src/leetCode/repository/No16最接近的三数之和.java)                                    |
|    17    |       电话号码的字母组合       |    中等     |                                             全排列,DFS                                             |                                  [leetCode.repository.No17电话号码的字母组合.java](src/leetCode/repository/No17电话号码的字母组合.java)                                   |
|    18    |         四数之和          |    中等     |                                             和三数之和类似                                             |                                       [leetCode.repository.No18四数之和.java](src/leetCode/repository/No18四数之和.java)                                        |
|    19    |     删除链表的倒数第N个节点      |    中等     |                                              快慢指针                                               |                               [leetCode.repository.No19删除链表的倒数第N个节点.java](src/leetCode/repository/No19删除链表的倒数第N个节点.java)                                |
|    20    |         有效的括号         |    简单     |                                             数据结构-栈                                              |                               [leetCode.repository.No22GenerateParentheses.java](src/leetCode/repository/No20有效的括号.java)                                |
|    21    |       合并两个有序链表        |    简单     |                                             数据结构-链表                                             |                                   [leetCode.repository.No21合并两个有序链表.java](src/leetCode/repository/No21合并两个有序链表.java)                                    |
...
|    24    |      两两交换链表中的节点       |    简单     |                                              一般的递归                                              |                                 [leetCode.repository.No24两两交换链表中的节点.java](src/leetCode/repository/No24两两交换链表中的节点.java)                                  |
...
|    28    |    找出字符串中第一个匹配项的下标    | 简单(KMP中等) |                                             经典字符串匹配                                             |                            [leetCode.repository.No28找出字符串中第一个匹配项的下标.java](src/leetCode/repository/No28找出字符串中第一个匹配项的下标.java)                             |
...
|   1969   |      数组元素的最小非零乘积      |    中等     |                                        寻找数学规律吧，另外别忘了快速幂                                         |            [No1969MinimumNonZeroProductOfTheArrayElements.java](src/leetCode/repository/No1969MinimumNonZeroProductOfTheArrayElements.java)             |
|   2475   |      数组中不等三元组的数目      |    简单     |                                          1.暴力 2.数学+哈希                                           |                                    [leetCode.No2475数组中不等三元组的数目.java](src/leetCode/repository/No2475数组中不等三元组的数目.java)                                    |
...
|  LCP 33  |          蓄水           |  简单(?中等)  |                                        1.暴力枚举 2.优先队列+贪心                                         |                                      [leetCode.repository.LCP_33_蓄水.java](src/leetCode/repository/LCP_33_蓄水.java)                                       |

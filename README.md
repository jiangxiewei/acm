...
| 题号  |     题名      | 难度 |               简介                |                             题解                             |
|:---:|:-----------:|:--:|:-------------------------------:|:----------------------------------------------------------:|
| 103 | 二叉树的锯齿形层序遍历 | 中等 |            基础的层序遍历题             | [java](java/src/leetCode/repository/No103二叉树的锯齿形层序遍历.java) |
...
|      题号       |     题名     | 难度 |       简介        |                                 题解                                 |
|:-------------:|:----------:|:--:|:---------------:|:------------------------------------------------------------------:|
|  leetcode 32  |   最长有效括号   | 困难 | 贪心/栈/动态规划 多种解法  |        [java](java/src/leetCode/repository/No32最长有效括号.java)        |
...
|  leetcode 53  |   最大子序和   | 简单 |               dp思路或者可以用数学推导求                |                   [java](java/src/leetCode/repository/No53最大子数组和.java)                   |
...
|    题号    |          题名           |   难度    |                                               简介                                                |                                               题解                                               |
|:--------:|:---------------------:|:-------:|:-----------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------:|
|    1     |         两数之和          |   简单    |                                          1.左右指针 2.Map                                           |       [java](java/src/leetCode/repository/No1.java)    [rust](rust/src/leetcode/no_1.rs)       |
|    2     |         两数相加          |   中等    |                                              链表相加                                               |       [java](java/src/leetCode/repository/No2.java)    [rust](rust/src/leetcode/no_2.rs)       |
|    5     |        最长回文子串         |   简单    |                                       1.dp找准状态转移逻辑 2.中心扩散                                       |    [java](java/src/leetCode/repository/No5最长回文子串.java)    [rust](rust/src/leetcode/no_5.rs)    |
|    9     |     is palindrome     |  eazy   |                                              eazy                                               |                               [rust](rust/src/leetcode/no_9.rs)                                |
|    10    |        正则表达式匹配        |   困难    |                                           依旧普通的递归搜索题                                            |                         [java](java/src/leetCode/repository/No10.java)                         |
|    11    |        盛最多水的容器        |   中等    |                                需要灵机一现的双指针，或者大力出奇迹的中心扩散（见rust代码）                                 |   [java](java/src/leetCode/repository/No11盛最多水的容器.java)  [rust](rust/src/leetcode/no_11.rs)    |
|    12    |        整数转罗马数字        |   中等    |                                              除+取余                                               |                     [java](java/src/leetCode/repository/No12整数转罗马数字.java)                      |
...
|    22    |         括号生成          |   中等    |                                             一般的搜索题                                              |               [java](java/src/leetCode/repository/No22GenerateParentheses.java)                |
|    24    |      两两交换链表中的节点       |   简单    |                                              一般的递归                                              |                    [java](java/src/leetCode/repository/No24两两交换链表中的节点.java)                    |
|    25    |       K 个一组翻转链表       |   困难    |                                               模拟题                                               |               [java](java/src/leetCode/repository/No25ReverseNodesInKGroup.java)               |
|    28    |    找出字符串中第一个匹配项的下标    |   简单    |                                             经典字符串匹配                                             |                 [java](java/src/leetCode/repository/No28找出字符串中第一个匹配项的下标.java)                  |
|    29    |         两数相除          |   中等    |                                             除法的底层实现                                             |                              [rust](rust/src/leetcode/no_29.rs))                               |
|    32    |        最长有效括号         |   困难    |                                         贪心/栈/动态规划 多种解法                                          |                      [java](java/src/leetCode/repository/No32最长有效括号.java)                      |
...
|    53    |        最大子数组和         |   简单    |                                         dp思路或者可以用数学推导求                                          |                      [java](java/src/leetCode/repository/No53最大子数组和.java)                      |
|    54    |         螺旋矩阵          |   中等    |                                 就是模拟,不过可用四个变量标记已遍历过的行和列来优化空间复杂度                                 |                       [java](java/src/leetCode/repository/No54螺旋矩阵.java)                       |
...
|   103    |      二叉树的锯齿形层序遍历      |   中等    |                                            基础的层序遍历题.                                            |                   [java](java/src/leetCode/repository/No103二叉树的锯齿形层序遍历.java)                   |
|   137    |      只出现一次的数字 II      |   中等    | 普通做法很简单,[不使用额外空间实现](https://blog.csdn.net/jiangxiewei/article/details/82227451) 就略麻烦,可能需要逻辑代数知识 |                        [java](java/src/leetCode/repository/No137.java)                         |
...
|   749    |         隔离病毒          |   困难    |                                           搜索、模拟、(并查集)                                           |                        [java](java/src/leetCode/repository/No749.java)                         |
...
|   945    |      使数组唯一的最小增量       |   中等    |                                            每日推荐里的水题                                             |        [java](java/src/leetCode/repository/No945MinimumIncrementToMakeArrayUnique.java)        |
...
|   1599   |      经营摩天轮的最大利润       |   中等    |                                               模拟                                                |                        [java](java/src/leetCode/repository/No1599.java)                        |
|   1606   |     找到处理最多请求的服务器      |   困难    |                           以模拟的前提下通过busy优先队列和available红黑树减少全服务器的遍历操作.                            |                  [java](java/src/leetCode/repository/No1606找到处理最多请求的服务器.java)                  |
|   1775   |    通过最少操作次数使数组的和相等    |   中等    |                                               模拟                                                |                        [java](java/src/leetCode/repository/No1775.java)                        |
...
|   3169   |       无需开会的工作日        |   中等    |                                              1.模拟                                               |                        [java](java/src/leetCode/repository/No3169.java)                        |
|   3175   |   找到连续赢 K 场比赛的第一位玩家   |   中等    |                                           1.模拟 2.找规律                                            |                        [java](java/src/leetCode/repository/No3175.java)                        |
|   3254   |   长度为 K 的子数组的能量值 I    |   中等    |                                                                                                 |                              [rust](rust/src/leetcode/no_3255.rs)                              |
|   3255   |   长度为 K 的子数组的能量值 II   |   中等    |                                                                                                 |                              [rust](rust/src/leetcode/no_3255.rs)                              |
|   3256   |     放三个车的价值之和最大 I     |   中等    |                                                                                                 |                              [rust](rust/src/leetcode/no_3257.rs)                              |
|   3257   |    放三个车的价值之和最大 II     |   困难    |                                                                                                 |                              [rust](rust/src/leetcode/no_3257.rs)                              |
|   3264   |    K 次乘运算后的最终数组 I     |   简单    |                                               简单                                                |                              [rust](rust/src/leetcode/no_3264.rs)                              |
|   3265   |      统计近似相等数对 I       |   中等    |                                               暴力                                                |                              [rust](rust/src/leetcode/no_3265.rs)                              |
|   3266   |    K 次乘运算后的最终数组 II    |   困难    |                                 快速幂 + 堆 + 贪心  PS:第一轮运算不要取模，不然G                                  |                              [rust](rust/src/leetcode/no_3266.rs)                              |
|   3270   |        求出数字答案         |   简单    |                                              简单暴力                                               |                        [java](java/src/leetCode/repository/No3270.java)                        |
|   3271   |        哈希分割字符串        |   中等    |                                              简单模拟                                               |                        [java](java/src/leetCode/repository/No3271.java)                        |
|   3272   |       统计好整数的数目        |   困难    |                                            枚举 + 排列组合                                            |                        [java](java/src/leetCode/repository/No3272.java)                        |
|   3273   |     对 Bob 造成的最少伤害     |   困难    |                                              数学分析                                               |                        [java](java/src/leetCode/repository/No3273.java)                        |
|   3274   |     检查棋盘方格颜色是否相同      |   简单    |                                              简单水题                                               |                        [java](java/src/leetCode/repository/No3274.java)                        |
|   3289   |       数字小镇中的捣蛋鬼       |   简单    |                                              简单水题                                               |                        [java](java/src/leetCode/repository/No3289.java)                        |
|   3290   |        最高乘法得分         |   简单    |                                              简单DP                                               |                        [java](java/src/leetCode/repository/No3290.java)                        |
...
|  LCP 80  |         生物进化录         |   中等    |                                           1.遍历树 2.规律                                            |                        [java](java/src/leetCode/repository/LCP_80.java)                        |
